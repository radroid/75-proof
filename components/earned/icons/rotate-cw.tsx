...
export function RotateCwEarned({ className }: { className?: string }) {
  return (
    ...
    >
      {/* arc — open at the top-right, swinging around clockwise */}
      <path d="M19.4 7.6 C 17.6 4.6, 14.4 3, 11 3.6 C 6.4 4.4, 3 8.6, 3.6 13.4 C 4.4 18.2, 9 21.2, 13.6 20.4 C 16.6 19.9, 19 17.6, 19.8 14.6" />
      {/* arrow head */}
