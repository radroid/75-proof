...
export function HeroSection({
  ...
  return (
    <section className={`relative w-full min-h-dvh overflow-hidden bg-background flex items-center justify-center ${className}`}>
      <div className="fixed inset-0 w-screen h-dvh">
        {mounted && (
          <>
            <MeshGradient
